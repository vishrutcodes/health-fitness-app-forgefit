...
export default function SignUpPage() {
    ...
    return (
        <div className="min-h-screen bg-[#030712] flex items-center justify-center px-4 py-12 relative overflow-hidden">
            ...
            <div className="pointer-events-none absolute bottom-0 left-0 h-[300px] w-[300px] rounded-full bg-forge-orange/3 blur-[100px]" />
            ...
            >
                ...
                <Card className="glass-card border-forge-border backdrop-blur-xl">
                    <CardHeader className="text-center pb-2">
                        ...
                        <CardDescription className="text-slate-400">Start your fitness transformation today</CardDescription>
                    </CardHeader>
                    <CardContent>
                        {success ? (
                            <motion.div
                            ...
                            >
                                ...
                                <p className="mt-2 text-sm text-slate-400">Redirecting you to the dashboard...</p>
                            </motion.div>
                        ) : (
                        ...
                        {!success && (
                            <div className="mt-6 text-center">
                                <p className="text-sm text-slate-400">
                                    ...
                                    <Link href="/auth/signin" className="text-forge-orange hover:text-forge-orange-light font-medium transition-colors">
                                        Sign In
                                    </Link>
                                </p>
                            </div>
                ...
                <p className="text-center text-xs text-slate-600 mt-6">
                    By creating an account, you agree to forge a better version of yourself 🔥
                </p>
            </motion.div>
        </div>
    );
