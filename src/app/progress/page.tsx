            ...
            <header className="sticky top-0 z-40 border-b border-forge-border bg-background/80 backdrop-blur-xl">
                <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3 sm:px-6">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="hidden sm:inline text-sm text-slate-400">PRs & Progress</span>
                    </div>
                    <div className="flex items-center gap-3">
            ...
            <main className="mx-auto max-w-6xl px-4 py-8 sm:px-6 space-y-8">
                ...
                <div className="flex items-center justify-between flex-wrap gap-4">
                    <div>
                        ...
                        <p className="text-sm text-slate-400 ml-6">Track your personal records and visualize your strength gains over time.</p>
                    </div>
